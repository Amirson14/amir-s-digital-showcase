    ...
    >
      ...
      >
        ...
        >
          ...
          מנהל מוצר AI עם 14 שנות ניסיון בהובלת צוותי טכנולוגיה ואיכות (QA). בעל ניסיון מעשי בבניית מוצרי AI מורכבים והפיכתם לפתרונות עסקיים מדויקים, תוך שילוב בין תכנון אסטרטגי, ניתוח דאטה והבנה טכנולוגית עמוקה
          </p>
        </motion.div>
